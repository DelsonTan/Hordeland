const jQueryApp = function(socket) {
  ...
  game.on("keydown", (event) => {
    event.preventDefault()
    if (event.which === 65 || event.which === 37) { pressing('left', true) } else if (event.which === 68 || event.which === 39) { pressing('right', true) } else if (event.which === 87 || event.which === 38) { pressing('up', true) } else if (event.which === 83 || event.which === 40) { pressing('down', true) } else if (event.which === 13) {
      event.preventDefault()
      cancelPlayerKeyPress()
      blurCanvas()
      focusChat()
  ...
  game.on("keyup", (event) => {
    if (event.which === 65 || event.which === 37) { pressing('left', false) } else if (event.which === 68 || event.which === 39) { pressing('right', false) } else if (event.which === 87 || event.which === 38) { pressing('up', false) } else if (event.which === 83 || event.which === 40) { pressing('down', false) }
  })
